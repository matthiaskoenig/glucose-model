function dxdt = sim_blood_flow_and_hepatocytes_ode(t,x,pars)

% Functions are needed to create the complex x vectors from the different
% modules. Dictionaries and hashmaps have to be created at the beginning
% which allow easy access to the mentioned variables.
