function [mca_c, mca_v, ss_c, ss_v] = sim_mca_glycolysis(glc_ext)
% Metabolic control analysis of glycolysis network
% Calculates the metabolic control coefficients for variations in Vmax
% Calculates the steady state concentrations
%
...
mpars.glc_ext = glc_ext;    % reference value of glucose
...
save(mpars.out_file, 'mpars', 'mca_c', 'mca_v', 'ss_c', 'ss_v', '-v7.3')
